...
public class TenantConnectionOptions {
  ...
  private List<String> domainAliases = null;

  public TenantConnectionOptions() {
  }

  public TenantConnectionOptions domainAliases(List<String> domainAliases) {
    
    this.domainAliases = domainAliases;
    return this;
  }

  public TenantConnectionOptions addDomainAliasesItem(String domainAliasesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domainAliases, tenantConnectionOptions.domainAliases);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domainAliases);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("domain_aliases") != null && !jsonObj.get("domain_aliases").isJsonArray()) {
