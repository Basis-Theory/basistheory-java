...
public class TenantUsageReport {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TenantUsageReport tenantUsageReport = (TenantUsageReport) o;
    return Objects.equals(this.tokenReport, tenantUsageReport.tokenReport);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tokenReport);
  }
  ...
  public String toString() {
    ...
    sb.append("    tokenReport: ").append(toIndentedString(tokenReport)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("token_report");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TenantUsageReport
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TenantUsageReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TenantUsageReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TenantUsageReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TenantUsageReport.class));

       return (TypeAdapter<T>) new TypeAdapter<TenantUsageReport>() {
           @Override
           public void write(JsonWriter out, TenantUsageReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TenantUsageReport read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TenantUsageReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TenantUsageReport
  * @throws IOException if the JSON string is invalid with respect to TenantUsageReport
  */
  public static TenantUsageReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TenantUsageReport.class);
  }

 /**
  * Convert an instance of TenantUsageReport to an JSON string
  *
  * @return JSON string
  */
