...
import com.basistheory.ApplicationTemplatesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationTemplatesApi apiInstance = new ApplicationTemplatesApi(defaultClient);
    try {
      List<ApplicationTemplate> result = apiInstance.get();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationTemplatesApi#get");
...
<a name="getById"></a>
# **getById**
> ApplicationTemplate getById(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ApplicationTemplatesApi#getById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
